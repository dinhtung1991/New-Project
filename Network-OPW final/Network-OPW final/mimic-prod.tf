module "vpc-mimic-prod" {
  source = "../templates/network/mimic-prod-network"
  project_name                        = "mimic"
  env                                 = "prod"
  ...
  private-cidr                        = ["172.30.10.0/24", "172.30.11.0/24",] #"10.4.12.0/24"]
  public-cidr                         = ["172.30.7.0/24", "172.30.8.0/24",] #"10.4.9.0/24"]
  tgw-attachment-cidr                 = ["172.30.13.0/28", "172.30.13.16/28",] #"10.4.13.32/28"]
...
module "ec2_instance_minic" {
  ...
  vpc_security_group_ids        = module.vpc-mimic-prod.mimic-prod-id
  subnet_id                     = module.vpc-mimic-prod.public-subnet_id[0]
  }
